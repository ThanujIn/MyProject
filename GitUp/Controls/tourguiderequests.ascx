<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tourguiderequests.ascx.cs" Inherits="Controls_tourguiderequests"%>
<style type="text/css">
    .auto-style1 {
        width: 99%;
        height: 162px;
...
<asp:DataList ID="DataList1" runat="server" Width="507px">
    <ItemTemplate>
        <table class="auto-style1" style="border: 1px ridge #CCCCCC;">
            <tr>
                <td class="auto-style6">Sender Name</td>
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:Button ID="Button1" runat="server" Text="Accept" CommandArgument='<%#Bind("BookingId") %>' OnClick="Button1_Click" />
                </td>
