<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Cars.aspx.cs" Inherits="CabService.Index3" EnableEventValidation="false" validateRequest="false"%>
...
<!--==============================Content=================================-->
			<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - April 07, 2014!</div>
				<div class="container_12">
					...
					<div class="grid_12">
						<h3>Lux<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TouristManagerConnectionString2 %>" SelectCommand="SELECT * FROM [BookedBy]"></asp:SqlDataSource>
                        </h3>
					</div>
					<div class="clear"></div>
					<div class="gallery">
