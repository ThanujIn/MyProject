<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TGChat.aspx.cs" Inherits="TGChat" %>
	    ...
	    <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="108px" Width="110px" />
                </td>
                <td>
            ...
            <tr>
                <td class="auto-style2">
                    <asp:ImageButton ID="ImageButton2" runat="server" Height="106px" Width="110px" />
                </td>
                <td>
